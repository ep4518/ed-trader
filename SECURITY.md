...
If you find a security vulnerability in ed_trader, please report it through [GitHub's private vulnerability reporting](https://github.com/ep4518/ed_trader/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact 146250552+ep4518@users.noreply.github.com for details.
